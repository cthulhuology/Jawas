...
static JSBool
obj_methods(JSContext* cx, JSObject* obj, uintN argc, jsval* argv, jsval* rval)
{
	return JS_TRUE;
}
...
static JSFunctionSpec object_methods[] = {
	...
	{js_methods_str, obj_methods, 0, 0, 0},
#if JS_HAS_OBJ_WATCHPOINT
...
/*
 * XXXbe if one adds props, deletes earlier props, adds more, the last added won't recycle the deleted props' slots.
 */
JSBool
